$(document).ready(function(){
    ...
    /*--------------------搜索框样式控制js------------------------*/
	 var search_types={
        "types":[{name:"wd",action:"https://www.baidu.com/s",stype:"img/searchChoice/scbaidugray.png",type:"baidu"},
                 {name:"query",action:"https://www.sogou.com/web",stype:"img/searchChoice/scsougougray.png",type:"sogou"},
                 {name:"q",action:"https://cn.bing.com/search",stype:"img/searchChoice/scbing.png",type:"bing"},
                 {name:"q",action:"https://www.so.com/s",stype:"img/searchChoice/sc360.png",type:"so"},
                 {name:"q",action:"https://www.google.com/search",stype:"img/searchChoice/scgoogle.png",type:"google"},
                 {name:"word",action:"http://www.cilimao.me/search",stype:"img/searchChoice/sccili.png",type:"cili"},
                 {name:"key",action:"http://neets.cc/search",stype:"img/searchChoice/scyingyin.png",type:"yingyin"},
                 
                ]};
	var checktype=$(".sChoiceBtn");
    var type=$(".scSmallBox");
    var seach_type=$(".scBigBox");
    var form=$(".first_two .first_two_one form");
    var textb=$(".first_two .first_two_one form .first_two_input1");
    var subb=$(".first_two .first_two_one form .first_two_input2");
    var tbcolor="#126AC1";
	...
	if(obj!=null){
        ...
        checktype.css({"background-image":"url("+obj.stype+")","background-size":"70%","background-position":"50% 50%"});
        checktype.css({"background-repeat":"no-repeat"});
	}
    ...
    type.click(function(){
        ...
        checktype.css({"background":"url("+search_types.types[$(this).index()].stype+")","background-size":"70%","background-position":"50% 50%"});
        checktype.css({"background-repeat":"no-repeat"});
...
function keydata(keys){
        ...
        var keywordbox=$(".first_two .first_two_one .keyword");//关键词盒子
        var textb=$(".first_two .first_two_one form .first_two_input1");
        var subb=$(".first_two .first_two_one form  .first_two_input2");
        if(len==0){
        ...
        keywordbox.children().click(function(){
            ...
            textb.focus();//输入框获取焦点*/
            $(".first_two .first_two_one form").submit();//提交搜索
        });
